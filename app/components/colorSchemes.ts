...
export const colorSchemes: Record<ColorSchemeKey, ColorScheme> = {
  gradient: {
    name: 'Sunset',
    background: 'bg-gradient-to-br from-orange-100 via-orange-300 via-pink-200 to-blue-600',
  ...
  brown: {
    ...
    customGradient: 'linear-gradient(135deg, #F8F4E1 0%, #AF8F6F 50%, #74512D 75%, #543310 100%)',
    textColor: 'text-gray-800',
  ...
  ocean: {
    name: 'Ocean',
    background: 'bg-gradient-to-br',
    customGradient: 'linear-gradient(135deg, #E0F2FE 0%, #7DD3FC 35%, #0EA5E9 70%, #0C4A6E 100%)',
    textColor: 'text-gray-800',
  ...
  forest: {
    name: 'Forest',
    background: 'bg-gradient-to-br',
    customGradient: 'linear-gradient(135deg, #ECFCCB 0%, #84CC16 35%, #365314 70%, #1A2E05 100%)',
    textColor: 'text-gray-800',
  ...
  lavender: {
    name: 'Lavender',
    background: 'bg-gradient-to-br',
    customGradient: 'linear-gradient(135deg, #F3E8FF 0%, #DDD6FE 35%, #A78BFA 70%, #6D28D9 100%)',
    textColor: 'text-gray-800',
  ...
  amethyst: {
    name: 'Amethyst',
    background: 'bg-gradient-to-br',
    customGradient: 'linear-gradient(135deg, #EEE4B1 0%, #8C6A5D 35%, #5F374B 70%, #430A5D 100%)',
    textColor: 'text-gray-800',
